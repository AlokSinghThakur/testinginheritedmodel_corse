      ...
      body: AvailableColorsWidget(
        ...
        child: Column(
          children: [
            ...
            ColorWidget(color: AvailableColors.one),
            ColorWidget(color: AvailableColors.two)
          ],
        ),
      ),
    );
...
class AvailableColorsWidget extends InheritedModel<AvailableColors> {
  ...
  AvailableColorsWidget({Key? key, required this.color1, required this.color2, required Widget child})
  ...
  bool updateShouldNotifyDependent(
      covariant AvailableColorsWidget oldWidget, Set<AvailableColors> dependencies) {
  ...
  Widget build(BuildContext context) {
    switch (color) {
      ...
      case AvailableColors.two:
        devtools.log('Colors2 Widget got rebuilt');
        break;
    }
